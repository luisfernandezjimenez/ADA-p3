...
-- Rellenar buffer con mensaje INIT y enviar al servidor
    ...
    Ada.Text_IO.Put_Line(ASCII.LF & "Mini-Chat v2.0: Welcome " & ASU.To_String(Nick));
...
exception
    ...
    when Admit_Error =>
        ...
        Ada.Text_IO.Put_Line(ASCII.LF & "Mini-Chat v2.0: IGNORED new user " &
