...
begin
    ...
    elsif Natural'Value(ACL.Argument(ACL.Argument_Count)) < 2 or else 
          Natural'Value(ACL.Argument(ACL.Argument_Count)) > 50 then
    ...
    Max_Clients := Natural'Value(ACL.Argument(ACL.Argument_Count));
